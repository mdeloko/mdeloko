...
- 😄 Pronomes: ele/dele
- 📚 Formações:
  - [x] Técnico em Informática integrado ao Ensino Médio - IFPR (Concluído em 2022)
  - [ ] Bacharelado em Engenharia de Computação - UTFPR (Previsão de Conclusão Dez/2026)
- 🔭 Estou em busca de uma oportunidade na área de tecnologia nas seguintes 
áreas: Web, Infra – DevOps, Jogos, Automações e Scripts
- 🏞️ Possuo bom conhecimento em Front-end com
  - JavaScript/TypeScript
  - React.js
  - Next.js
- 🏗️ Possuo bom conhecimento em Back-end com
  - Node.js
  - GoLang
  - Python
  - Java
- ⚙️ Possuo conhecimento em Infra/DevOps com
  - AWS
  - OCI
  - Azure/AzureDevops
  - Terraform
  - Docker / Docker Compose
- 🤖 Possuo conhecimento em Script/Automações e Jogos com
  - Bash
  - Python
  - Lua
  - Go
...
<div>
  ...
  <a href="https://www.youtube.com/@taldovortex" target="_blank"><img src="https://img.shields.io/badge/YouTube-FF0000?style=for-the-badge&logo=youtube&logoColor=white" target="_blank"></a>
</div>
